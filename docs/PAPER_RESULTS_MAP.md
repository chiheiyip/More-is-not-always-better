...
| 2.7 Statistical analysis | `05_statistical_models.py` | `outputs/06_models/model_results.csv`, `model_diagnostics.csv`, `modality_sample_flow.csv`, `metric_sample_summary.csv`, `eye_qc_sensitivity_models.csv`, `eye_mde_monte_carlo.csv` |

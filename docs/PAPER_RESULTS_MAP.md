...
| 2.6.3 Questionnaire | `01_questionnaire_pipeline.py` | `outputs/02_questionnaire/questionnaire_analysis_long.csv`, `questionnaire_analysis_sample.csv`, `questionnaire_paper_tables.md` |
